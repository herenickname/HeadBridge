...
- [ ] Confirm the GitHub Actions build uses only the checked-in public half of
  the HeadBridge self-signed identity and contains no Apple Team Identifier.
- [ ] Confirm a real update retains the existing macOS Bluetooth permission.
